...
🌐 Acesse: https://adegatabariapdv.netlify.app/
  ...
  abrirModalPendentes() {
    ...
    const pendentes = JSON.parse(localStorage.getItem('mt_usuarios_pendentes')) || [];
  ...
  confirmarAprovacao(e, index) {
    ...
    localStorage.setItem('mt_usuarios_pendentes', JSON.stringify(pendentes));
